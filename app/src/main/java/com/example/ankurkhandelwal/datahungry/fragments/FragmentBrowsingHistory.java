...
public class FragmentBrowsingHistory extends Fragment {
    String TAG = "FragmentBrowsingHistory";
    ...
    class C03201 implements OnClickListener {
        ...
        public void onClick(View view) {
            FragmentBrowsingHistory.this.refresh_view();
        }
    }
    ...
    private void readBrowsingData() {
        ...
        if (this.marshMallowPermission.checkPermissionForReadPhoneLogs()) {
            ...
            while (cur.moveToNext()) {
                this.callLogArrayList.add(new CallLogsData(cur.getString(0), cur.getString(1), cur.getString(2), 0));
            }
